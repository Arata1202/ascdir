...
```sh
ASCDIR_VERSION=v1.2.0 sh install.sh
```
...
Most individual developers only need the app identity and the localization
fields generated by `ascdir init`. The remaining sections below are opt-in:
